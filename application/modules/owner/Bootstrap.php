...
class Owner_Bootstrap extends Zend_Application_Module_Bootstrap
{
	...
	protected function _initTranslate() {
		...
		$translate = new Zend_Translate('tmx', APPLICATION_PATH . '/modules/employee/languages/', $langLocale.'.ini',
		...
		$registry->set('Zend_Translate_Employee', $translate);
