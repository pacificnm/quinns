...
class Report_Form_Audit extends Zend_Form
{
	...
	{
		$this->addElement(new Report_Form_Element_Employee('employee'));
		
		$this->addElement(new Report_Form_Element_StartDate('startDate'));
		
		$this->addElement(new Report_Form_Element_EndDate('endDate'));
		
		$this->addElement(new Report_Form_Element_Module('sModule'));
