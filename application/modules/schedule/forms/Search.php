 ...
 * @version    $Id$
 */
class Schedule_Form_Search extends Zend_Form
{	
	/**
	 * Construct
	 */
    ...
    public function init()
    {
        ...
        $this->addElement(new Schedule_Form_Element_StartDate('postStartDate'));
        
        $this->addElement(new Schedule_Form_Element_EndDate('postEndDate'));
