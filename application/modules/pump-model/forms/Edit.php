...
class PumpModel_Form_Edit extends Zend_Form
{
     ...
     * @return PumpModel_Form_Edit
     */
    public function pumpModel($pumpModel)
    {
    	$element = new PumpModel_Form_Element_Value('value');
    	$element->setValue($pumpModel->value);
